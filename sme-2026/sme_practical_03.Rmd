...
trinidad <- read_stata(here("sme-2026/data", "trinmlsh17.dta")) |> 
...
Now, from smokenum, we'll create a new variable called "smokstatus" that identifies the participants who were active smokers at entry into the study.
...
mort <- read_stata(here("sme-2026/data", "mortality17.dta")) |> 
